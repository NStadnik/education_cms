...
final class SettingsController extends \App\Controllers\AdminBaseController
{
    ...
    private function normalizeHeaderLayout(string $json): array
    {
        ...
        return [
            ...
            'hero_variant' => $this->choice((string) ($data['hero_variant'] ?? 'default'), ['default', 'accent', 'compact', 'fullscreen'], 'default'),
            ...
            'mobile_source' => $this->choice((string) ($data['mobile_source'] ?? 'main'), ['main', 'secondary', 'both'], 'main'),
