...
final class Database
{
    ...
    private function invalidatesPublicQueryCache(string $sql): bool
    {
        ...
        return preg_match('/\b(settings|pages|news|news_categories|news_category_links|media|forms|form_submissions|external_identities|external_auth_nonces)\b/i', $sql) === 1;
    }
}
