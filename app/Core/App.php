...
use App\Controllers\Admin\PublicInfoController;
...
final class App
{
    ...
    private function routes(): void
    {
        ...
        $adminDocuments = DocumentsController::class;
        $adminMedia = MediaController::class;
        $adminPublicInfo = PublicInfoController::class;
        ...
        $this->router->get('/admin/public-info', [$adminPublicInfo, 'publicInfo']);
        $this->router->get('/admin/public-info/sections/edit', [$adminPublicInfo, 'publicInfoSectionForm']);
        $this->router->get('/admin/public-info/documents/edit', [$adminPublicInfo, 'publicInfoDocumentForm']);
        $this->router->post('/admin/public-info/save', [$adminPublicInfo, 'publicInfoSave']);
        $this->router->post('/admin/public-info/sections/save', [$adminPublicInfo, 'publicInfoSectionSave']);
        $this->router->post('/admin/public-info/sections/delete', [$adminPublicInfo, 'publicInfoSectionDelete']);
        $this->router->post('/admin/public-info/bulk', [$adminPublicInfo, 'publicInfoBulk']);
