...
final class App
{
    ...
    private function routes(): void
    {
        ...
        $this->router->post('/admin/pages/bulk', [$admin, 'pagesBulk']);
        ...
        $this->router->post('/admin/news/bulk', [$admin, 'newsBulk']);
        ...
        $this->router->post('/admin/documents/bulk', [$admin, 'documentsBulk']);
        ...
        $this->router->post('/admin/media/bulk', [$admin, 'mediaBulk']);
        ...
        $this->router->post('/admin/public-info/bulk', [$admin, 'publicInfoBulk']);
        ...
        $this->router->post('/admin/users/bulk', [$admin, 'usersBulk']);
