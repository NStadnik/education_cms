<div class="page-head">
    <div>
        ...
        <h1>Імпорт</h1>
        <p class="page-subtitle">Завантажте CSV/JSON або підключіться до WordPress бази даних, перегляньте записи й запустіть імпорт без перезавантаження сторінки.</p>
    </div>
</div>
